package com.ott.reelpick.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.ott.reelpick.config.jwt.JwtFactory;
import com.ott.reelpick.config.jwt.JwtProperties;
import com.ott.reelpick.user.dto.CreateAccessTokenRequest;
...
class TokenApiControllerTest {
    ...
    public void createNewAccessToken() throws Exception {
        ...
        String refreshToekn = JwtFactory.builder()
                .claims(Map.of("user_idx", testUser.getUserId()))
                .build()
