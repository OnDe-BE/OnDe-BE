...
public interface CategorySortRepository extends JpaRepository<CategorySort, String> {
    ...
    @Query(value = "SELECT count(*) from category_sort where category_code REGEXP :categoryCode",nativeQuery = true)
    Integer countByCategoryCode(@Param("categoryCode")String categoryCode);
}
